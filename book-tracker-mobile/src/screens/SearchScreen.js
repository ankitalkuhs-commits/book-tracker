...
const styles = StyleSheet.create({
  ...
  searchInput: {
    ...
    fontSize: 15, backgroundColor: colors.surfaceContainerLow, color: colors.onSurface,
  },
  searchButton: {
  ...
  addButton: {
    ...
    borderRadius: radius.md, alignSelf: 'flex-start', minWidth: 120, alignItems: 'center',
  },
  ...
  modalContent: {
    ...
    paddingTop: 20, paddingHorizontal: 20, paddingBottom: 40, maxHeight: '85%',
  },
  ...
  selectedBookInfo: {
    ...
    padding: 12, borderRadius: radius.md, marginBottom: 18,
  },
